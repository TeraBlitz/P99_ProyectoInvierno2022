...
function StudentProfile({
  studentInfo, addStudent, setAddStudent, userID,
  ...
  const [userState, setUserState] = useState(estadosMexico[0]);
  const [userEducationInput, setUserEducationInput] = useState('');
  const [userEducation, setUserEducation] = useState(nivelEscolaridad[0]);
