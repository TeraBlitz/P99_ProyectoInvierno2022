...
function EditStudentProfile({
  studentInfo, openEditModal, setOpenEditModal, isEditing, setIsEditing,
  ...
  const [userState, setUserState] = useState(estadosMexico[estadosMexico.indexOf(studentInfo.estado)]);
  const [userEducationInput, setUserEducationInput] = useState(studentInfo.escolaridad);
  const [userEducation, setUserEducation] = useState(nivelEscolaridad[nivelEscolaridad.indexOf(studentInfo.escolaridad)]);
