...
export default function Periodos() {
  ...
  const postCrea = async (e) => {
    e.preventDefault();
    try {
      await fetch("https://p99test.fly.dev.dev/v1/periodos/create", {
        method: "POST",
        headers: {
  ...
  const postDelete = async (e) => {
    try {
      await fetch("https://p99test.fly.dev.dev/v1/periodos/delete", {
        method: "Delete",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
  ...
  const postEditar = async (e) => {
    e.preventDefault();
    try {
      await fetch("https://p99test.fly.dev.dev/v1/periodos/update", {
        method: "Put",
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
