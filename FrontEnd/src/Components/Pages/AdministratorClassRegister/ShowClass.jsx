...
export default function ShowClass() {
  ...
  const getOptions = async () => {
    await fetch("https://p99test/v1/profesores/", {
      method: "GET",
      headers: {
  ...
  const resetClases = async () => {
    await fetch("https://p99test/v1/clases/", {
      method: "GET",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
  ...
  const handleClick = async (e) => {
    ...
    await fetch("https://p99test/v1/clases/create", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
  ...
  const sendCSV = async (csv) => {
    ...
    await fetch("https://p99test/v1/csv/subirClases", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
    ...
    await fetch("https://p99test/v1/csv/subirProfesores", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
  ...
  const updateClass = (nuevaClase) => {
    ...
    delete nuevaClase.niveles;
    fetch("https://p99test/v1/clases/update", {
      method: "PUT",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
  ...
  async function deleteClass(id) {
    await fetch("https://p99test/v1/clases/delete", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
      },
